...
### 3. backuppass \"testbackuppassword\" 	 equals to: backuppass \"your backup password\"
...
### 6. sftpuser \"testsftpuser\"		 equals to: sftpuser \"your sftp username\"
### 7. sftppassword \"textsftppassword\"	 equals to: sftppassword \"your sftp password\"
### 8. sftpip \"10.10.100.200\"			 equals to: sftpip \"your sftp server ip\"
### 9.a. sftpdirpath \"noc/uploads\"		 equals to: sftpdirpath \"your directory path on sftp server without opening and closing slash\"
### 9.b. notes: if its using subdiretory in a directory just using single slash in between the directory and its sub directory
### 
### 10. sftpport \"22\"				equals to: sftpport \"your sftp applications port number on the server\"	
...
add comment="Ori AKA RH" dont-require-permissions=yes name=\
    ...
    \n:local textfile\r\
    \n:local backupfile\r\
    \n:local backuppass \"testbackuppassword\"\r\
    \n:local encryptionmethod1 \"aes-sha256\"\r\
    \n:local encryptionmethod2 \"rc4\"\r\
    \n:local sftpuser \"testsftpuser\"\r\
    \n:local sftppassword \"textsftppassword \"\r\
    \n:local sftpip \"10.10.100.200\"\r\
    \n:local sftpdirpath \"noc/uploads\"\r\
    \n:local sftpport \"22\"\r\
